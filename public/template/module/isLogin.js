...
//      		console.log(this.rem.pass)
        		this.hello.html(`欢迎来到快乐购！${this.rem.user},你好    <u style="cursor:pointer">[注销]</u>`);
        		this.rightAccount.html(`<dt>欢迎来到快乐购</dt>
        		...
        		this.hello.html('欢迎来到快乐购！<a href="login.html">[请登录]</a><a href="register.html">[免费注册]</a>');
        		this.rightAccount.html(`<dt>欢迎来到快乐购</dt>
